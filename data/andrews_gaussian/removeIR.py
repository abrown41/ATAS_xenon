...
field= np.loadtxt("EField.inp")[:,3]

time, dtot = np.loadtxt("expec_z_all.Xe_ATAS00002200",skiprows=1)[:,0], np.loadtxt("expec_z_all.Xe_ATAS00002200",skiprows=1)[:,1]
dipole = dtot-dIR
...
et =  np.concatenate((prepad,  field))
